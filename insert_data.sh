...
# empty both tables before inserting data
echo $($PSQL "TRUNCATE games, teams")

cat games.csv | while IFS="," read YEAR ROUND WINNER OPPONENT WINNER_GOALS OPPONENT_GOALS; do
  # get teams information from winner, checking it's not the first / descriptive line
  ...
  # get teams information from opponent, checking it's not the first / descriptive line
  ...
  # get game information, checking it's not the first / descriptive line
  if [[ $YEAR != year ]]; then
    # get game id
